...
class JewelryPageContent extends StatelessWidget {
  const JewelryPageContent({super.key});
    ...
    return Consumer<ProductCatalogModel>(
      builder:
          (BuildContext context, ProductCatalogModel catalog, Widget? child) {
            final List<Product> products = catalog.jewelryProducts;
            if (products.isEmpty) {
              return const Center(
                child: Text(
                  "No hay productos de joyería disponibles.",
